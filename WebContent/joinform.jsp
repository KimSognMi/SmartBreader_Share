...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/joinstyle.css" media="screen" title="no title" charset="utf-8">
            ...
            <div class="field3">
              <label for="username">휴대폰 인증</label>
                ...
                <span class="input-group-btn">
                  <button class="button">인증번호 전송<i class="fa fa-mail-forward spaceLeft"></i></button>
                </span>
              </div>
