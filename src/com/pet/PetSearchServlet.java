...
public class PetSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<NoPetNoMapMemberDTO> nolist = new ArrayList<NoPetNoMapMemberDTO>();
		...
		if (dto != null) {
			...
			try {
				...
				nolist = (ArrayList<NoPetNoMapMemberDTO>) service.nopetnomapmember(keyword);

				if (nolist.toString() != null) {
					if (list.size() > 0) {
